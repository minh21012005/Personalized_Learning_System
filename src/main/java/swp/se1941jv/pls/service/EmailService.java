...
public class EmailService {
    ...
    public void sendEmailVerificationEmail(String toEmail, String token) throws MessagingException {
        MimeMessage message = mailSender.createMimeMessage();
        MimeMessageHelper helper = new MimeMessageHelper(message, true);

        helper.setFrom(fromEmail);
        helper.setTo(toEmail);
        helper.setSubject("Xác thực Email - Hệ thống Học tập Cá nhân hóa");

        // Tạo URL xác thực email
                                ...
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%%" style="max-width: 600px; background-color: #ffffff; border-radius: 15px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.1);">
                                    ...
                                    <tr>
                                        <td style="padding: 40px 30px; text-align: center;">
                                            ...
                                            <p style="font-size: 16px; line-height: 1.5; margin: 0 0 20px;">
                                                Cảm ơn bạn đã đăng ký tài khoản tại Hệ thống Học tập Cá nhân hóa. Vui lòng nhấp vào nút dưới đây để xác thực email của bạn và kích hoạt tài khoản:
                                            </p>
                                            ...
                                            <p style="font-size: 14px; line-height: 1.5; color: #666; margin: 20px 0;">
                                                Liên kết này sẽ hết hạn sau 24 giờ. Nếu bạn không đăng ký tài khoản, vui lòng bỏ qua email này.
                                            </p>
                                        </td>
                                    </tr>
                                    <!-- Footer -->
