            ...
            <div class="content">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <p><span class="info-label">Giá:</span> ${pkg.price} VNĐ</p>
                ...
                <div class="mt-3">
                    <c:if test="${pkg.status == 'PENDING'}">
                        <form action="/manager/package/approve/${pkg.packageId}" method="post" style="display:inline;">
                            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
                            <button type="submit" class="btn btn-success"><i class="bi bi-check-circle"></i>
                                Duyệt</button>
                        </form>
                        <form action="/manager/package/reject/${pkg.packageId}" method="post" style="display:inline;">
