						...
						<div class="row">
							...
							<div class="col-md-9">
								<div class="main-content">
									<form:form action="/account/profile" method="post" modelAttribute="user"
										enctype="multipart/form-data">
										<div class="form-section">
											<div class="row">
												<div class="col-md-6 mb-3">
													<label for="fullName" class="form-label">Họ và tên</label>
													<form:input type="text" class="form-control form__item"
														id="fullName" path="fullName" required="true" />
												...
												<div class="col-md-6 mb-3">
													...
													<form:input type="date" class="form-control form__item"
														id="birthDate" path="dob" required="true" />
													<c:set var="errorDob">
												...
												<div class="col-md-6 mb-3">
													...
													<form:input type="email" class="form-control form__item" id="email"
														path="email" required="true" readonly="true" />
												...
												<div class="col-md-6 mb-3">
													...
													<form:input type="text" class="form-control form__item" id="phone"
												...
												<div class="col-12 mt-3">
													...
													<div class="mt-2">
														<button type="button" class="btn btn-remove-image"
															id="removeImageBtn"
															style="display: ${not empty user.avatar ? 'inline-block' : 'none'}">Xóa
															ảnh</button>
													</div>
												</div>
											</div>
