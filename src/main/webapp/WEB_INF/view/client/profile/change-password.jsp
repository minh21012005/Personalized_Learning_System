                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="password-change-content">
                                    ...
                                    <form:form action="/account/profile/change-password" method="post"
                                        modelAttribute="passwordChangeRequest" id="changePasswordForm">
                                        <div class="password-form-section">
                                            <div class="row d-flex justify-content-lg-start" style="width: 80%">
                                                <div class="col-md-7 mb-3">
                                                    <label for="oldPassword" class="form-label">Mật khẩu cũ</label>
                                                    <form:input type="password" class="form-control form-item"
                                                        id="oldPassword" path="oldPassword" required="true" />
                                                ...
                                                <div class="col-md-7  mb-3">
                                                    ...
                                                    <form:input type="password" class="form-control form-item"
                                                        id="newPassword" path="newPassword" required="true" />
                                                ...
                                                <div class="col-md-7  mb-3">
                                                    <label for="confirmNewPassword" class="form-label">Nhập lại mật khẩu
                                                        mới</label>
                                                    <input type="password" class="form-control form-item"
                                                        id="confirmNewPassword" name="confirmNewPassword"
                                                        required="true" />
                                                    <div id="confirmPasswordError" class="text-danger"
                                                        style="display: none;">Mật khẩu nhập lại không khớp!</div>
                                                </div>
                                            </div>
                                            <div class="col-md-2 mt-2 d-flex justify-content-center">
                                                <button type="submit" class="btn btn-save-password">Lưu thay
                                                    đổi</button>
                                            </div>
                                        </div>
                                    </form:form>
