                    ...
                    <div class="form-container">
                        ...
                        <form action="/practice/start-practice" method="get" id="practiceForm">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="checkbox-group" id="levelGroup">
                                    <c:forEach var="level" items="${levels}">
                                        <label><input type="checkbox" name="levelIds"
                                                      value="${level.levelQuestionId}"> ${level.levelQuestionName}
                                        </label>
                                    </c:forEach>
                                </div>
                            </div>
                            <div class="form-group mb-3">
                                ...
                                <input type="number" name="questionCount" class="form-control" min="1" max="50"
                                       value="10" required>
                            </div>
