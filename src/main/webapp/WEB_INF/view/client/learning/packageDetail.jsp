...
<head>
    ...
    <title>PLS - Danh sách môn học</title>
...
<div class="main-container">
    <div class="content">
        <div class="package-header">
            <div class="row">
                <div class="col-md-8">
                    <h2>${packageSubject.name}</h2>
                    <p>${packageSubject.description}</p>
                </div>
                <div class="col-md-4">
                    <img src="/img/package/${packageSubject.imageUrl != null ? packageSubject.imageUrl : '/img/default-package.jpg'}"
                         alt="${packageSubject.name}" class="img-fluid">
                </div>
