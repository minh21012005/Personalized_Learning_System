                ...
                <div class="container-fluid px-4">
                    <div class="card mt-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <a href="/staff/subject" class="btn btn-outline-secondary btn-sm">
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-3">
                                <form action="/staff/subject/${subject.subjectId}/chapters" method="get"
                                    ...
                                    <a href="/staff/subject/${subject.subjectId}/chapters"
                                       class="btn btn-outline-secondary btn-sm ms-2">Xóa lọc</a>
                                </form>
                                <a href="/staff/subject/${subject.subjectId}/chapters/new" class="btn btn-primary btn-sm mt-2 mt-md-0">
                                    Tạo chương học mới
                                </a>
                            </div>
                            ...
                            <div class="mb-3">
                                <form id="toggleStatusForm" action="/staff/subject/${subject.subjectId}/chapters/update-status" method="post" onsubmit="return toggleChapters(event)">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="text-center col-3">Mô tả</th>
                                        <th scope="col" class="text-center col-2">Trạng thái phê duyệt</th>
                                        <th scope="col" class="text-center col-1">Hiển thị</th>
                                    ...
                                    <c:if test="${not empty chapters}">
                                        <c:forEach var="chapter" items="${chapters}">
                                            <tr>
                                                ...
                                                <td class="col-3">${chapter.chapterDescription}</td>
                                                ...
                                                <td class="text-center col-3">
                                                    ...
                                                    <a href="/staff/subject/${subject.subjectId}/chapters/${chapter.chapterId}/edit"
                                                       class="btn btn-warning btn-sm mb-1 mb-lg-0" title="Cập nhật">
                                                        Cập nhật
                                                    </a>
                                                    <c:choose>
                                                        <c:when test="${chapter.chapterStatus.statusCode == 'DRAFT'}">
                                                            <form action="/staff/subject/${subject.subjectId}/chapters/${chapter.chapterId}/submit" method="post" style="display: inline;">
                                                                <input type="hidden" name="_csrf" value="${_csrf.token}"/>
                                                                <button type="submit" class="btn btn-primary btn-sm mb-1 mb-lg-0" title="Nộp">Nộp</button>
                                                            </form>
                                                        </c:when>
                                                        <c:when test="${chapter.chapterStatus.statusCode == 'PENDING'}">
                                                            <form action="/staff/subject/${subject.subjectId}/chapters/${chapter.chapterId}/cancel" method="post" style="display: inline;">
                                                                <input type="hidden" name="_csrf" value="${_csrf.token}"/>
                                                                <button type="submit" class="btn btn-secondary btn-sm mb-1 mb-lg-0" title="Hủy">Hủy</button>
                                                            </form>
                                                        </c:when>
                                                    </c:choose>
                                    ...
                                    <c:if test="${empty chapters}">
                                        <tr>
                                            <td colspan="6" class="text-center">Chưa có chương học nào.</td>
                                        </tr>
                                    </c:if>
                                    </tbody>
                                </table>
